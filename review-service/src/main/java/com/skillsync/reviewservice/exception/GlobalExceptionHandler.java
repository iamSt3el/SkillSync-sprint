...
import com.skillsync.reviewservice.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleReviewNotFound(ReviewNotFoundException ex, HttpServletRequest request) {
